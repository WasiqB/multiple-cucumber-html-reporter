          ...
          (o.prototype = {
            ...
            rotate: function (t) {
              var e = this.values.hsl,
                a = (e[0] + t) % 360;
              return (
                (e[0] = a < 0 ? 360 + a : a), this.setValues("hsl", e), this
              );
            },
            mix: function (t, e) {
              var a = this,
            ...
            (o.prototype.setValues = function (t, e) {
              ...
              if ("alpha" === t) s = e;
                ...
                (n[t] = e.slice(0, t.length)), (s = e[t.length]);
              ...
              for (a = 0; a < t.length; a++)
                (u = Math.max(0, Math.min(r[t][a], n[t][a]))),
                  (n[t][a] = Math.round(u));
        ...
        function (t, e, a) {
          ...
          function T(t) {
            var e,
              ...
              s = t[3] / 100;
            return (
              (e = 1 - Math.min(1, n * (1 - s) + s)),
              (a = 1 - Math.min(1, o * (1 - s) + s)),
          ...
          function B(t) {
            ...
            return (
              ...
              (i =
                i / 108.883 <= 0.008859
                  ? (i = (108.883 * (n - s / 200 - 16 / 116)) / 7.787)
                  : 108.883 * Math.pow(n - s / 200, 3)),
              [e, a, i]
            );
          }
          function z(t) {
            ...
            (t.defaults.bar = {
              ...
              (t.controllers.bar = t.DatasetController.extend({
                  ...
                  return (
                    e.each(
                      ...
                      function (e, a) {
                        ...
                        o.bar &&
                          t.chart.isDatasetVisible(a) &&
                          (i.options.stacked === !1 ||
                            (i.options.stacked === !0 &&
                              n.indexOf(o.stack) === -1) ||
                            (void 0 === i.options.stacked &&
                              (void 0 === o.stack ||
                                n.indexOf(o.stack) === -1))) &&
                          n.push(o.stack);
                      },
                ...
                calculateBarBase: function (t, e) {
                  ...
                  if (
                    n.options.stacked === !0 ||
                    (void 0 === n.options.stacked && void 0 !== i.stack)
                  ) {
                    for (
                      var s = a.chart,
                        l = s.data.datasets,
                ...
                getStackIndex: function (t) {
                  ...
                  for (a = 0; a < t; ++a)
                    (e = this.chart.getDatasetMeta(a)),
                      e.bar &&
                        this.chart.isDatasetVisible(a) &&
                        (o.options.stacked === !1 ||
                          (o.options.stacked === !0 &&
                            r.indexOf(e.stack) === -1) ||
                          (void 0 === o.options.stacked &&
                            (void 0 === e.stack ||
                              r.indexOf(e.stack) === -1))) &&
                        r.push(e.stack);
                  return r.length - 1;
                ...
                calculateBarX: function (t, e, a) {
                  ...
                  return (
                    (s -= i.chart.isCombo ? a.tickWidth / 2 : 0),
                    s +
                      a.barWidth / 2 +
                      a.categorySpacing +
                      a.barWidth * r +
                ...
                calculateBarY: function (t, e) {
                  ...
                  if (
                    ...
                    for (
                      var r = n.getBaseValue(), s = r, l = r, u = 0;
                      u < e;
                      u++
                    ) {
              ...
              (t.controllers.horizontalBar = t.controllers.bar.extend({
                ...
                calculateBarY: function (t, e, a) {
                  var i = this,
                    ...
                    s = o.getPixelForValue(null, t, e, i.chart.isCombo);
                  return (
                    (s -= i.chart.isCombo ? a.tickHeight / 2 : 0),
                    s +
                      a.barHeight / 2 +
                      a.categorySpacing +
                      a.barHeight * r +
              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                updateElement: function (t, e, i) {
                  var n,
                    ...
                    m =
                      1 === p.length || 1 === u.data.length || r.chart.isCombo;
                  void 0 !== u.radius &&
                    ...
                    (o = i ? h.getBasePixel() : r.calculatePointY(c, e, d)),
                    (t._xScale = f),
                    (t._yScale = h),
                    (t._datasetIndex = d),
                    (t._index = e),
                    (t._model = {
                      ...
                      radius:
                        l.radius ||
                        a.getValueAtIndexOrDefault(u.pointRadius, e, g.radius),
                      pointStyle:
                        l.pointStyle ||
                ...
                updateBezierControlPoints: function () {
                  ...
                  if (
                    ...
                    a.splineCurveMonotone(d);
                  else
                    for (e = 0, i = d.length; e < i; ++e)
                      (n = d[e]),
                        (o = n._model),
                        (r = a.splineCurve(
                          a.previousItem(d, e)._model,
                          o,
                          a.nextItem(d, e)._model,
                ...
                draw: function (a) {
                  ...
                  for (
                    t.canvasHelpers.clipArea(
                      ...
                      e(o.getDataset(), o.chart.options) &&
                        r.dataset.transition(l).draw(),
                      t.canvasHelpers.unclipArea(o.chart.chart.ctx),
                      i = 0,
                      n = s.length;
                    i < n;
                    ++i
              ...
              (t.controllers.polarArea = t.DatasetController.extend({
                ...
                updateElement: function (t, a, i) {
                  ...
                  var b = s.startAngle,
                    x = t.hidden
                      ? 0
                      : u.getDistanceFromCenterForValue(r.data[a]),
                    y = b + h * p,
                    k = y + (t.hidden ? 0 : h),
                    S = l.animateScale
                      ? 0
          ...
          e.exports = function (t) {
            ...
            (e.drawPoint = function (e, a, i, n, o) {
              ...
              if (
                ...
                return void e.drawImage(a, n - a.width / 2, o - a.height / 2);
              if (!(isNaN(i) || i <= 0)) {
                switch (a) {
                  default:
                    e.beginPath(),
              ...
              i.extend(t.Controller.prototype, {
                  ...
                  if (
                    (i.each(
                      ...
                      function (i, o) {
                        ...
                        r.type || (r.type = i.type || e.config.type),
                          a.push(r.type),
                          r.controller
                ...
                update: function (t, e) {
                  ...
                  if ((a(o), n.notify(o, "beforeUpdate") !== !1)) {
                    ...
                    i.each(
                      ...
                      o.updateDatasets(),
                      n.notify(o, "afterUpdate"),
                      o._bufferedRender
                        ? (o._bufferedRequest = { lazy: e, duration: t })
                        : o.render(t, e);
                  }
                },
                updateLayout: function () {
                  var e = this;
                  n.notify(e, "beforeLayout") !== !1 &&
                    (t.layoutService.update(
                      this,
                      this.chart.width,
                      this.chart.height
                    ),
                    n.notify(e, "afterScaleUpdate"),
                    n.notify(e, "afterLayout"));
                },
                  ...
                  if (n.notify(o, "beforeRender") !== !1) {
                    ...
                    if (
                      ...
                      (("undefined" != typeof e && 0 !== e) ||
                        ("undefined" == typeof e && 0 !== r.duration))
                    ) {
                      var l = new t.Animation();
                      (l.numSteps = (e || r.duration) / 16.66),
                        (l.easing = r.easing),
                        ...
                        (l.onAnimationProgress = r.onProgress),
                        (l.onAnimationComplete = s),
                        t.animationService.addAnimation(o, l, e, a);
                    } else o.draw(), s();
                    return o;
                  }
                },
                draw: function (t) {
                  ...
                  e.clear(),
                    ...
                    n.notify(e, "beforeDraw", [t]) !== !1 &&
                      ...
                      n.notify(e, "afterDraw", [t]));
                },
                drawDatasets: function (t) {
                  var e = this;
                  n.notify(e, "beforeDatasetsDraw", [t]) !== !1 &&
                    (i.each(
                      e.data.datasets,
                      function (a, i) {
                        e.isDatasetVisible(i) &&
                          e.getDatasetMeta(i).controller.draw(t);
                      },
                      e,
                      !0
                    ),
                    n.notify(e, "afterDatasetsDraw", [t]));
                },
                ...
                destroy: function () {
                  ...
                  for (s.stop(), a = 0, r = s.data.datasets.length; a < r; ++a)
                    (e = s.getDatasetMeta(a)),
                      e.controller &&
                        (e.controller.destroy(), (e.controller = null));
                  l &&
                    (s.unbindEvents(),
                    i.clear(s.chart),
                    o.releaseContext(s.chart.ctx),
                    (s.chart.canvas = null),
                    (s.chart.ctx = null)),
                    n.notify(s, "destroy"),
                ...
                handleEvent: function (t) {
                  ...
                  return (
                    ...
                    n.onHover && n.onHover.call(e, t.native, e.active),
                    ("mouseup" !== t.type && "click" !== t.type) ||
                      (a.onClick && a.onClick.call(e, t.native, e.active)),
                    e.lastActive.length &&
                      e.updateHoverStyle(e.lastActive, n.mode, !1),
                    e.active.length &&
                      n.mode &&
                      e.updateHoverStyle(e.active, n.mode, !0),
                    (o = !i.arrayEquals(e.active, e.lastActive)),
              ...
              i.extend(t.DatasetController.prototype, {
                ...
                setHoverStyle: function (t) {
                  var e = this.chart.data.datasets[t._datasetIndex],
                    ...
                    r = i.getHoverColor,
                    s = t._model;
                  (s.backgroundColor = n.hoverBackgroundColor
                    ? n.hoverBackgroundColor
                    : o(e.hoverBackgroundColor, a, r(s.backgroundColor))),
                    (s.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : o(e.hoverBorderColor, a, r(s.borderColor))),
                    (s.borderWidth = n.hoverBorderWidth
                      ? n.hoverBorderWidth
                      : o(e.hoverBorderWidth, a, s.borderWidth));
                },
          ...
          e.exports = function (t) {
            function e(t, e, a) {
              ...
              return (
                "string" == typeof t
                  ? ((i = parseInt(t, 10)),
                    t.indexOf("%") !== -1 && (i = (i / 100) * e.parentNode[a]))
                  : (i = t),
                i
              );
            }
            ...
            function n(t, i, n) {
              ...
              return u || d
                ? Math.min(u ? e(s, t, n) : c, d ? e(l, r, n) : c)
                : "none";
            }
            var o = (t.helpers = {});
            (o.each = function (t, e, a, i) {
              ...
              if (o.isArray(t))
                ...
                else for (n = 0; n < r; n++) e.call(a, t[n], n);
              else if ("object" == typeof t) {
                var s = Object.keys(t);
                      ...
                      ? i.hasOwnProperty(a)
                        ? o.each(e, function (e, n) {
                            ...
                            n >= i[a].length || !i[a][n].type
                              ? i[a].push(o.configMerge(s, e))
                              : e.type && e.type !== i[a][n].type
                              ? (i[a][n] = o.configMerge(i[a][n], s, e))
            ...
            (o.requestAnimFrame = (function () {
              ...
              (o.getRelativePosition = function (t, e) {
                ...
                return (
                  (a = Math.round(
                    (((a - s.left - u) / f) * r.width) /
                      e.currentDevicePixelRatio
                  )),
                  (i = Math.round(
                    (((i - s.top - d) / g) * r.height) /
                      e.currentDevicePixelRatio
                  )),
                  { x: a, y: i }
                );
              ...
              update: function (t, a, i) {
                function n(t) {
                  var e,
                    a = t.isHorizontal();
                  a
                    ? ((e = t.update(t.options.fullWidth ? x : C, w)),
                      (I -= e.height))
                    : ((e = t.update(M, S)), (C -= e.width)),
                    D.push({ horizontal: a, minSize: e, box: t });
                }
                function o(t) {
                ...
                function s(t) {
                  t.isHorizontal()
                    ? ((t.left = t.options.fullWidth ? d : F),
                      (t.right = t.options.fullWidth ? a - c : F + C),
                      (t.top = E),
                      (t.bottom = E + t.height),
                      (E = t.bottom))
                    : ((t.left = N),
            ...
            (t.defaults.global.legend = {
              ...
              (t.Legend = t.Element.extend({
                ...
                fit: function () {
                  ...
                  if (
                    (m
                      ? ((p.width = a.maxWidth), (p.height = r ? 10 : 0))
                      : ((p.width = r ? 10 : 0), (p.height = a.maxHeight)),
                    r)
                  )
                    if (((s.font = f), m)) {
                      ...
                      (s.textAlign = "left"),
                        ...
                        i.each(a.legendItems, function (t, i) {
                          ...
                          v[v.length - 1] + r + o.padding >= a.width &&
                            ((b += d + o.padding), (v[v.length] = a.left)),
                      ...
                      i.each(a.legendItems, function (t, a) {
                        ...
                        M + w > p.height &&
                          ((k += S + o.padding), y.push(S), (S = 0), (M = 0)),
                          (S = Math.max(S, n)),
                          (M += w),
                          (g[a] = { left: 0, top: 0, width: n, height: d });
                      }),
                        (k += S),
                        y.push(S),
                        (p.width += k);
                      ...
                      y = function (e, a, i) {
                        if (!(isNaN(b) || b <= 0)) {
                          ...
                          if (
                            ...
                            o || c.strokeRect(e, a, b, g),
                              c.fillRect(e, a, b, g);
                          c.restore();
                        }
                      },
                      k = function (t, e, a, i) {
                        c.fillText(a.text, b + g / 2 + t, e),
                          a.hidden &&
                            (c.beginPath(),
                            (c.lineWidth = 2),
                    ...
                    i.each(a.legendItems, function (t, e) {
                      ...
                      S
                        ? r + n >= l &&
                          ((s = d.y += M),
                          d.line++,
                          (r = d.x = a.left + (l - u[d.line]) / 2))
                        : s + M > a.bottom &&
                          ((r = d.x = r + a.columnWidths[d.line] + o.padding),
                          (s = d.y = a.top + o.padding),
                          d.line++),
                        y(r, s, t),
                        (x[e].left = r),
                        (x[e].top = s),
                        k(r, s, t, i),
                        S ? (d.x += n + o.padding) : (d.y += M);
                    });
                  }
                },
                handleEvent: function (t) {
                  ...
                  if (
                    ...
                    for (var s = e.legendHitBoxes, l = 0; l < s.length; ++l) {
                      ...
                      if (
                        ...
                        if ("click" === i) {
                          a.onClick.call(e, t.native, e.legendItems[l]),
                            (n = !0);
                          break;
                        }
                        if ("mousemove" === i) {
                          a.onHover.call(e, t.native, e.legendItems[l]),
                            (n = !0);
                          break;
                        }
                      }
              ...
              t.plugins.register({
                ...
                beforeUpdate: function (e) {
                  ...
                  n
                    ? ((n = i.configMerge(t.defaults.global.legend, n)),
                      e.legend ? (e.legend.options = n) : a(e, n))
                    : (t.layoutService.removeBox(e, e.legend), delete e.legend);
                },
            ...
            (t.defaults.scale = {
              ...
              (t.Scale = t.Element.extend({
                ...
                beforeTickToLabelConversion: function () {
                  i.callCallback(this.options.beforeTickToLabelConversion, [
                    this,
                  ]);
                },
                ...
                afterTickToLabelConversion: function () {
                  i.callCallback(this.options.afterTickToLabelConversion, [
                    this,
                  ]);
                },
                beforeCalculateTickRotation: function () {
                  i.callCallback(this.options.beforeCalculateTickRotation, [
                    this,
                  ]);
                },
                ...
                afterCalculateTickRotation: function () {
                  i.callCallback(this.options.afterCalculateTickRotation, [
                    this,
                  ]);
                },
                beforeFit: function () {
                ...
                fit: function () {
                  ...
                  if (
                    (d
                      ? (n.width = t.isFullWidth()
                          ? t.maxWidth - t.margins.left - t.margins.right
                          : t.maxWidth)
                      : (n.width = u && l.drawTicks ? f : 0),
                    d
                      ? (n.height = u && l.drawTicks ? f : 0)
                      : (n.height = t.maxHeight),
                    s.display && u && (d ? (n.height += h) : (n.width += h)),
                    r.display && u)
                  ) {
                    var g = i.longestText(
                        t.ctx,
                    ...
                    if (d) {
                      ...
                      var v = i.toRadians(t.labelRotation),
                        ...
                        x = Math.sin(v),
                        y = x * g + c.size * p + m * p;
                      (n.height = Math.min(t.maxHeight, n.height + y)),
                        (t.ctx.font = c.font);
                      var k = t.ticks[0],
                        S = e(t.ctx, k, c.font),
                      ...
                      0 !== t.labelRotation
                        ? ((t.paddingLeft =
                            "bottom" === o.position ? b * S + 3 : b * m + 3),
                          (t.paddingRight =
                            "bottom" === o.position ? b * m + 3 : b * w + 3))
                        : ((t.paddingLeft = S / 2 + 3),
                          (t.paddingRight = w / 2 + 3));
                    } else
                      r.mirror ? (g = 0) : (g += t.options.ticks.padding),
                        (n.width += g),
                  ...
                  if (o.display) {
                    ...
                    if (p) {
                      if (
                        ((r = !1),
                        f && (C /= 2),
                        (C + d.autoSkipPadding) * n.ticks.length >
                    ...
                    if (
                      (i.each(n.ticks, function (t, a) {
                        if (void 0 !== t && null !== t) {
                          var s = n.ticks.length === a + 1,
                            l =
                              (r > 1 && a % r > 0) ||
                              (a % r === 0 && a + r >= n.ticks.length);
                          if ((!l || s) && void 0 !== t && null !== t) {
                            var u, h;
                            a ===
                            ("undefined" != typeof n.zeroLineIndex
                              ? n.zeroLineIndex
                              : 0)
                              ? ((u = c.zeroLineWidth), (h = c.zeroLineColor))
                              : ((u = i.getValueAtIndexOrDefault(
                                  c.lineWidth,
                                  a
                                )),
                                (h = i.getValueAtIndexOrDefault(c.color, a)));
                            var g,
                              m,
                              v,
                              k,
                            ...
                            if (p) {
                              ...
                              (F =
                                n.getPixelForTick(a, c.offsetGridLines) +
                                d.labelOffset),
                                (g = v = S = C = L),
                                (m = T),
                                (k = P),
                              ...
                              d.mirror
                                ...
                                (F = z ? n.right - B : n.left + B);
                              var N = n.getPixelForTick(a);
                              (N += i.aliasPixel(u)),
                                (V = n.getPixelForTick(a, c.offsetGridLines)),
                                (g = D),
                                (v = A),
                                (S = e.left),
                                (C = e.right),
                      ...
                      if (p)
                        ...
                        (_ = R ? n.left + S.size / 2 : n.right - S.size / 2),
                          (F = n.top + (n.bottom - n.top) / 2),
                          (V = R ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      l.save(),
                        l.translate(_, F),
                        l.rotate(V),
                    ...
                    if (c.drawBorder) {
                      ...
                      p
                        ? ((B = z = "top" === o.position ? n.bottom : n.top),
                          (B += W),
                          (z += W))
                        : ((O = L = "left" === o.position ? n.right : n.left),
                          (O += W),
                          (L += W)),
                        l.beginPath(),
                        l.moveTo(O, B),
            ...
            t.Ticks = {
              generators: {
                ...
                logarithmic: function (t, a) {
                  ...
                  0 === s
                    ? ((i = Math.floor(e.log10(a.minNotZero))),
                      (n = Math.floor(a.minNotZero / Math.pow(10, i))),
                      o.push(s),
                      (s = n * Math.pow(10, i)))
                    : ((i = Math.floor(e.log10(s))),
                      (n = Math.floor(s / Math.pow(10, i))));
                  do
                    o.push(s),
                      ++n,
                      10 === n && ((n = 1), ++i),
          ...
          e.exports = function (t) {
            ...
            (t.Title = t.Element.extend({
              ...
              fit: function () {
                ...
                e.isHorizontal()
                  ? ((l.width = e.maxWidth),
                    (l.height = r ? s + 2 * n.padding : 0))
                  : ((l.width = r ? s + 2 * n.padding : 0),
              ...
              t.plugins.register({
                ...
                beforeUpdate: function (i) {
                  ...
                  n
                    ? ((n = a.configMerge(t.defaults.global.title, n)),
                      i.titleBlock ? (i.titleBlock.options = n) : e(i, n))
                    : (t.layoutService.removeBox(i, i.titleBlock),
                      delete i.titleBlock);
                },
              });
          };
        ...
        function (t, e, a) {
          ...
          e.exports = function (t) {
            ...
            function a(t, e) {
              return (
                e &&
                  (l.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                t
              );
            }
            function i(t) {
            ...
            function o(t, e) {
              ...
              return (
                ...
                l.each(e.title, g),
                (a.font = l.fontString(c, e._bodyFontStyle, e._bodyFontFamily)),
            ...
            function r(t, e) {
              ...
              "center" === r
                ...
                s(a.x)
                  ? ((o = "left"), u(a.x) && ((o = "center"), (r = c(a.y))))
                  : l(a.x) &&
                    ((o = "right"), d(a.x) && ((o = "center"), (r = c(a.y))));
              var g = t._options;
              return {
            ...
            function s(t, e, a) {
              ...
              return (
                ...
                "top" === u
                  ? (n += d)
                  : (n -= "bottom" === u ? e.height + d : e.height / 2),
                "center" === u
                  ? "left" === l
                    ? (i += d)
                    : "right" === l && (i -= d)
                ...
                update: function (e) {
                  ...
                  if (g.length) {
                    ...
                    c.filter &&
                      ...
                      (f.title = d.getTitle(S, p)),
                      (f.beforeBody = d.getBeforeBody(S, p)),
                      (f.body = d.getBody(S, p)),
                      (f.afterBody = d.getAfterBody(S, p)),
                      (f.footer = d.getFooter(S, p)),
                      (f.x = Math.round(y.x)),
                      (f.y = Math.round(y.y)),
                      (f.caretPadding = l.getValueOrDefault(y.padding, 2)),
                      (f.labelColors = k),
                      (f.dataPoints = S),
                      (x = o(this, f)),
                      (v = r(this, x)),
                  ...
                  if (o.length) {
                    ...
                    for (u = 0, d = o.length; u < d; ++u)
                      i.fillText(o[u], t.x, t.y),
                        (t.y += r + s),
                        u + 1 === o.length && (t.y += a.titleMarginBottom - s);
                  }
                },
                      ...
                      l.each(r.before, c),
                        l.each(r.lines, function (r) {
                          h &&
                            ...
                            (i.strokeStyle = e(
                              a.labelColors[s].borderColor,
                              n
                            )),
                            i.strokeRect(t.x, t.y, o, o),
                            (i.fillStyle = e(
                              a.labelColors[s].backgroundColor,
                              n
                            )),
                ...
                draw: function () {
                  function t(t, e) {
                    ...
                    e._view.steppedLine === !0
                      ? (l.lineTo(a.x, t._view.y), l.lineTo(a.x, a.y))
                      : 0 === e._view.tension
                      ? l.lineTo(a.x, a.y)
                      : l.bezierCurveTo(
                  ...
                  if (u.length && n.fill) {
                    for (l.beginPath(), c = 0; c < u.length; ++c)
                      (h = u[c]),
                        ...
                        (g = h._view),
                        0 === c
                          ? (s ? l.moveTo(r.x, r.y) : l.moveTo(g.x, r),
                            g.skip || ((d = c), l.lineTo(g.x, g.y)))
                          : ((f = d === -1 ? f : u[d]),
                            g.skip
                              ? o ||
                                d !== c - 1 ||
                                (s
                                  ? l.lineTo(r.x, r.y)
                                  : l.lineTo(f._view.x, r))
                              : (d !== c - 1
                                  ? o && d !== -1
                                    ? t(f, h)
                                    : s
                                    ? l.lineTo(g.x, g.y)
                                    : (l.lineTo(g.x, r), l.lineTo(g.x, g.y))
                                  : t(f, h),
                                (d = c)));
                    s || d === -1 || l.lineTo(u[d]._view.x, r),
                      (l.fillStyle = n.backgroundColor || a.defaultColor),
                      l.closePath(),
                      l.fill();
                  }
                  var p = a.elements.line;
                  for (
                    l.lineCap = n.borderCapStyle || p.borderCapStyle,
                      l.setLineDash &&
                        l.setLineDash(n.borderDash || p.borderDash),
                      l.lineDashOffset =
                        n.borderDashOffset || p.borderDashOffset,
                      l.lineJoin = n.borderJoinStyle || p.borderJoinStyle,
                      l.lineWidth = n.borderWidth || p.borderWidth,
                      l.strokeStyle = n.borderColor || a.defaultColor,
                      l.beginPath(),
                      d = -1,
                      c = 0;
                    c < u.length;
              ...
              (t.elements.Point = t.Element.extend({
                ...
                draw: function (e) {
                  var a = this._view,
                    ...
                    g = 0;
                  a.skip ||
                    ((s.strokeStyle = a.borderColor || o),
                    (s.lineWidth = i.getValueOrDefault(
                      a.borderWidth,
                      n.elements.point.borderWidth
                    )),
                    (s.fillStyle = a.backgroundColor || o),
                    void 0 !== e &&
                      (r.x < e.left ||
                        e.right * f < r.x ||
                        r.y < e.top ||
              ...
              i = t.Scale.extend({
                ...
                getPixelForValue: function (t, e, a, i) {
                  ...
                  var d = n.height / o,
                    c = d * (e - n.minIndex);
                  return (
                    n.options.gridLines.offsetGridLines && i && (c += d / 2),
                    n.top + Math.round(c)
                  );
                },
                getPixelForTick: function (t, e) {
                ...
                getValueForPixel: function (t) {
                  ...
                  return (
                    (t -= n ? a.left : a.top),
                    a.options.gridLines.offsetGridLines && (t -= o / 2),
              ...
              i = t.LinearScaleBase.extend({
                ...
                getPixelForValue: function (t) {
                  ...
                  return a.isHorizontal()
                    ? ((e = a.left + (a.width / o) * (n - i)), Math.round(e))
                    : ((e = a.bottom - (a.height / o) * (n - i)),
                      Math.round(e));
                },
                getValueForPixel: function (t) {
                  var e = this,
            ...
            t.LinearScaleBase = t.Scale.extend({
              ...
              buildTicks: function () {
                ...
                a.handleDirectionalChanges(),
                  ...
                  (a.min = e.min(s)),
                  n.reverse
                    ? (s.reverse(), (a.start = a.max), (a.end = a.min))
              ...
              i = t.Scale.extend({
                    ...
                    o.isHorizontal()
                      ? ((n = e.log10(o.end) - e.log10(r)),
                        0 === s
                          ? (i = o.left)
                          : ((a = o.width),
                            (i = o.left + (a / n) * (e.log10(s) - e.log10(r)))))
                      : ((a = o.height),
                        0 !== r || u.reverse
                          ? 0 === o.end && u.reverse
                              ...
                              (i =
                                s === o.end
                                  ...
                                  : o.top +
                                    0.02 * a +
                                    ((0.98 * a) / n) *
                                      (e.log10(s) - e.log10(o.minNotZero))))
                            : ((n = e.log10(o.end) - e.log10(r)),
                              (a = o.height),
                              (i =
                                o.bottom - (a / n) * (e.log10(s) - e.log10(r))))
                ...
                getValueForPixel: function (t) {
                  ...
                  return (
                    n.isHorizontal()
                      ? ((i = n.width),
                        (a = n.start * Math.pow(10, ((t - n.left) * o) / i)))
                      : ((i = n.height),
                        (a = Math.pow(10, ((n.bottom - t) * o) / i) / n.start)),
                    a
                  );
                },
              });
        ...
        function (t, e, a) {
          ...
          e.exports = function (t) {
            ...
            function o(t) {
              ...
              var h = e(t);
              for (o = 0; o < h; o++) {
                (s = t.getPointPosition(o, u)),
                  (r = i(t.ctx, l.size, t.pointLabels[o] || "")),
            ...
            function l(t, e, a, i) {
              if (f.isArray(e))
                for (var n = a.y, o = 1.5 * i, r = 0; r < e.length; ++r)
            ...
            function d(t) {
              ...
              for (var p = e(t) - 1; p >= 0; p--) {
                ...
                (i.textAlign = s(y)),
                  ...
                  l(i, t.pointLabels[p] || "", v, h.size);
              }
            }
            function c(t, a, i, n) {
              var o = t.ctx;
              if (
                ((o.strokeStyle = f.getValueAtIndexOrDefault(a.color, n - 1)),
                (o.lineWidth = f.getValueAtIndexOrDefault(a.lineWidth, n - 1)),
                t.options.lineArc)
              )
                o.beginPath(),
            ...
            var f = t.helpers,
              ...
              m = t.LinearScaleBase.extend({
                  ...
                  f.each(e.data.datasets, function (n, o) {
                    if (e.isDatasetVisible(o)) {
                      ...
                      f.each(n.data, function (e, n) {
                        ...
                        isNaN(o) ||
                          r.data[n].hidden ||
                          ((a = Math.min(o, a)), (i = Math.max(o, i)));
                      });
                    }
                  }),
                    (t.min = a === Number.POSITIVE_INFINITY ? 0 : a),
                ...
                setCenterPoint: function (t, e, a, i) {
                  ...
                  (n.xCenter = Math.round((r + o) / 2 + n.left)),
                    (n.yCenter = Math.round((s + l) / 2 + n.top));
                },
                    ...
                    f.each(t.ticks, function (s, l) {
                      if (l > 0 || e.reverse) {
                        var d = t.getDistanceFromCenterForValue(
                          ...
                          h = t.yCenter - d;
                        if (
                          (a.display && 0 !== l && c(t, a, d, l), i.display)
                        ) {
                  ...
                  buildTicks: function () {
                    ...
                    if (
                      ...
                      for (var g = 0, p = a.units[g]; g < a.units.length; ) {
                        ...
                        (i.scaleSizeInUnits =
                          i.lastTick.diff(i.firstTick, i.tickUnit, !0) + v + b),
                          (i.displayFormat =
                    ...
                    for (
                      var S = i.unitScale;
                      S <= i.scaleSizeInUnits;
                      S += i.unitScale
                    ) {
                      var M = x.clone().add(S, i.tickUnit);
                      if (
                        i.options.time.max &&
                        M.diff(i.lastTick, i.tickUnit, !0) >= 0
                      )
                        break;
                      i.ticks.push(M);
                    }
                    var w = i.ticks[i.ticks.length - 1].diff(
                      i.lastTick,
                      i.tickUnit
                    );
                    (0 === w && 0 !== i.scaleSizeInUnits) ||
                      (i.options.time.max
