...
The popup used by `modal` layout has its own behavior options — backdrop, drag, resize, and a step/scenario context caption. See [Attachment Display Options](/docs/options#attachment-display-options) for the full list.
