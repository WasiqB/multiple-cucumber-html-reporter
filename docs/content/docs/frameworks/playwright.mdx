...
// package.json
{
  "scripts": {
    ...
    "posttest": "tsx src/utils/generate-report.ts"
  },
}
```
...
- `pnpm posttest` - Generate HTML reports by using the Cucumber generated JSON reports.
...
### Run the Tests and generate report [step]
...
This command will execute all your test cases and generate HTML report at the end.
