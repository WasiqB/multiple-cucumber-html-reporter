...
It is suggested to use this option only when all the feature files have executed on the same browser, platform or app.
</Callout>
...
Use metadata of `Metadata` or `Record<string, Metadata>` type instead.
</Callout>
