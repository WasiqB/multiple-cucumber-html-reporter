...
Check out more about the [command line tool](/docs/latest/cli).
...
For WebdriverIO users, please check our [WebdriverIO Integration Guide](/docs/latest/frameworks/webdriverio) for a simplified setup.
</Callout>
